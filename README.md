...
最初的开发愿景只是做个小工具，因此代码写得非常烂，大佬们请见谅
...
* 圣遗物 OCR 导出
  ...
  - 快速抓取模式下的点击不要太快（1.1.7版本后建议至少1秒1次），百度 api 默认限制 1 秒两次请求。**可开通标准版的付费识别功能提升QPS**（付费不是一定要给钱，每天前50000次还是免费的） 
  - 由于百度OCR的结果经常把某些字符和数字漏掉，程序对一些异常的数值做了尝试性的修复， **所以结果未必百分百准确，请务必核对** 
